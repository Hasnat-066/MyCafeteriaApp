            ...
            addToCartButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (quantity > 0) {
                        ...
                        String rawPrice = itemPriceTextView.getText().toString();
// Ye line "Rs." "₹" ya koi bhi text hata degi aur sirf number rakhegi
                        String priceString = rawPrice.replaceAll("[^0-9.]", "");

                        double price = 0;
                        try {
                            price = Double.parseDouble(priceString);
                        } catch (NumberFormatException e) {
                            price = 0; // Agar koi ghalti hui to 0 price set ho jayegi crash nahi hoga
                        }
