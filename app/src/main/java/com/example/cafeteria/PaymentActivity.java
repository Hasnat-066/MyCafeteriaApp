...
public class PaymentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (extras != null && extras.containsKey("totalAmount")) {
            ...
            totalAmountTextView.setText("Total: " + String.format(Locale.getDefault(), "Rs. %.2f", totalAmount));
        }
        ...
        confirmButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String paymentConfirmationMessage = "Payment of " + String.format(Locale.getDefault(), "Rs. %.2f", totalAmount) + " confirmed.";
