    ...
    private void displayCartItems() {
        ...
        if (cartItems.isEmpty()) {
            ...
            for (ShoppingCart.CartItem cartItem : cartItems) {
                ...
                // Yahan "Rs." dikhana zaroori hai
                itemPriceTextView.setText("Rs. " + cartItem.getPrice());
        ...
        // FINAL TOTAL DISPLAY - Yahan maine ₹ ko Rs. kar diya hai
        totalAmountTextView.setText("Total: Rs. " + String.format(Locale.getDefault(), "%.2f", totalAmount));
    }
}